...
func convertPanicToErrorList(lastToken *token, errors *[]error) {
	if lastToken != nil && *lastToken != nil {
...
func configureSystemAccount(o *Options, m map[string]interface{}) (err error) {
	var lt token
	defer convertPanicToError(&lt, &err)
...
func parseServiceLatency(root token, v interface{}) (l *serviceLatency, err error) {
	var lt token
	defer convertPanicToError(&lt, &err)
...
func parseTLS(v interface{}) (t *TLSConfigOpts, err error) {
	var (
